...
<body class="bg-gray-900 text-gray-100">
            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-48 bg-gray-800/90 backdrop-blur-md rounded-md shadow-lg py-2 z-50 hidden group-hover:block border border-gray-700/50">
                            <a href="#" class="block px-4 py-2  hover:bg-gray-700/50 hover:text-white">Web Development</a>
                            <a href="#" class="block px-4 py-2  hover:bg-gray-700/50 hover:text-white">SEO Services</a>
                            <a href="#" class="block px-4 py-2  hover:bg-gray-700/50 hover:text-white">Digital Marketing</a>
                            <a href="#" class="block px-4 py-2  hover:bg-gray-700/50 hover:text-white">Graphic Design</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        mobileMenuButton.addEventListener('click', () => {
            ...
            // Animate the mobile menu with GSAP
        ...
        const servicesLink = mobileMenu.querySelector('a[href="#"]');
        servicesLink.addEventListener('click', (e) => {
            e.preventDefault();
            mobileServices.classList.toggle('hidden');
            
            if (mobileServices.classList.contains('hidden')) {
                gsap.to(mobileServices, {
                    height: 0,
                    opacity: 0,
                    duration: 0.2
                });
            } else {
                gsap.from(mobileServices, {
                    height: 0,
                    opacity: 0,
                    duration: 0.2
                });
